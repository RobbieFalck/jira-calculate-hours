...
// @include     https://yourcompany.atlassian.net*
...
function addTotalFooterJQL() {
    ...
    resultLastRow.find(".customfield_12133").html(sumTotal(resultRow.find(".customfield_12133")));
    resultLastRow.find(".customfield_12134").html(sumTotal(resultRow.find(".customfield_12134")));
